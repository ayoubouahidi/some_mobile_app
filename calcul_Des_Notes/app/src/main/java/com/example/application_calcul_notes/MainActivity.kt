    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnC = findViewById<Button>(R.id.btn1)
            ...
            btnC.setOnClickListener{
                val note_1 = findViewById<EditText>(R.id.ip1).text.toString()
                val note_2 = findViewById<EditText>(R.id.ip2).text.toString()
                val note_3 = findViewById<EditText>(R.id.ip3).text.toString()
                val note_4 = findViewById<EditText>(R.id.ip4).text.toString()
